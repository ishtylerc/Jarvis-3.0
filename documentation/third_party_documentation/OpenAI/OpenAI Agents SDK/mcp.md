...
The [Model context protocol (aka MCP)](https://docs.modelcontextprotocol.org/) is a way to provide tools and context to the LLM. From the MCP docs:
...
![MCP Tracing Screenshot](https://openai.github.io/openai-agents-python/_images/mcp-tracing.png) 