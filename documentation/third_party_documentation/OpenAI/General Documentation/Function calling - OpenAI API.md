...
published:
created: 2025-03-20
description: "Learn how function calling enables large language models (LLMs) to fetch data, take action, and connect to external data and systems."
tags:
  - "clippings"
---
...
- **Call model with [functions defined](https://platform.openai.com/docs/guides/?api-mode=responses#defining-functions)** – along with your system and user messages.
...
- **Execute function code** – parse the model's response and [handle function calls](https://platform.openai.com/docs/guides/?api-mode=responses#handling-function-calls).
...
1. **Forced Function:** Call exactly one specific function. `tool_choice: {"type": "function", "name": "get_weather"}`
...
**Note:** Currently, if the model calls multiple functions in one turn then [strict mode](https://platform.openai.com/docs/guides/?api-mode=responses#strict-mode) will be disabled for those calls.
